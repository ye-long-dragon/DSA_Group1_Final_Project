...
namespace DSA_Group1_Final_Project.Windows.UserControls.Admin
{
    public partial class ViewCurriculumDetails : UserControl
    {
        ...
        {
            InitializeComponent();
            this.student = student; // Store student details for later use

            Debug.WriteLine($"Viewing curriculum details for student: {student.Name}");


       
            // Display student information (Modify as needed)
